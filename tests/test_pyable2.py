...
def main():
    """Legacy manual rotation script; not intended for pytest collection."""
    A = imaginable.SITKImaginable(
        filename='/data/MYDATA/TDCS/EROS_TDCS/Healthy/NC_sub14_20190117/POST_LCA_PHA_s10383653-0074-00001-000001-01.nii'
    )
